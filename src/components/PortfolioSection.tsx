        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-xs animate-in fade-in duration-150">
          <div className="bg-white dark:bg-slate-900 rounded-3xl max-w-2xl w-full border border-slate-200 dark:border-slate-800 shadow-2xl p-6 space-y-5 max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400">
                    Apex Equities portfolio tax estimation summary
                  </p>
                </div>
              </div>
              <button
            ...
            <p className="text-[10px] text-slate-500 dark:text-slate-400 leading-relaxed italic">
              Note: This computation is an informational estimation generated by Apex Equities for personal tracking. Apex Equities is an independent tracking platform and is not affiliated with any government, regulatory, or tax authority.
            </p>
